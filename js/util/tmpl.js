define(["jquery", "baiduTemplate"], function($, bt){
	...
	function getInsertUserTmplate(){
		var user = {
			...
			modaltitle: "添加用户",
			inputs: [
			{id: "userid",title: "用户ID:",type: "text"},
			{id: "username",title: "用户名:",type: "text"},
			{id: "sex",title: "性别:",type: "text"},
			{id: "tel",title: "电话:",type: "text"},
